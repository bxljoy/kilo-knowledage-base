...
export function HelpModal({ open, onOpenChange }: HelpModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-slate-800 rounded-xl shadow-2xl w-full max-w-3xl max-h-[80vh] overflow-hidden flex flex-col border border-slate-700">
        {/* Header */}
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-semibold text-white mb-1">Create a Knowledge Base</h4>
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-semibold text-white mb-1">Upload PDF Documents</h4>
            <p className="text-sm text-slate-400">
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-semibold text-white mb-1">Wait for Processing</h4>
            <p className="text-sm text-slate-400">
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-semibold text-white mb-1">Start Chatting</h4>
            <p className="text-sm text-slate-400">
      ...
      <div className="grid gap-4">
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-white mb-1">AI-Powered Chat</h4>
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-white mb-1">Multiple Knowledge Bases</h4>
              <p className="text-sm text-slate-300">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="border-b border-slate-700 pb-4">
          <h4 className="font-semibold text-white mb-2">What are the file size limits?</h4>
          <p className="text-sm text-slate-400">
        ...
        <div className="border-b border-slate-700 pb-4">
          <h4 className="font-semibold text-white mb-2">How many questions can I ask per day?</h4>
          <p className="text-sm text-slate-400">
        ...
        <div className="border-b border-slate-700 pb-4">
          <h4 className="font-semibold text-white mb-2">How accurate are the AI responses?</h4>
          <p className="text-sm text-slate-400">
        ...
        <div className="border-b border-slate-700 pb-4">
          <h4 className="font-semibold text-white mb-2">Can I delete uploaded documents?</h4>
          <p className="text-sm text-slate-400">
        ...
        <div className="border-b border-slate-700 pb-4">
          <h4 className="font-semibold text-white mb-2">What happens if processing fails?</h4>
          <p className="text-sm text-slate-400">
